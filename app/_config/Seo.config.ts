...
export const _seoConfig = {
  ...
  sponsors: {
    path: "/sponsors",
    image: "/home_hero.webp",
    title: "Partner With a Movement of Devotion | Bharat Bhakti Sangam",
    description:
    ...
    keywords: [
      ...
      "devotional event sponsorship",
      "spiritual music event partner",
      "bhajan clubbing sponsor",
      "delhi ncr event partner",
      "youth spiritual movement sponsor",
      "cultural partnership india",
      "brand partnership devotion",
      "presenting partner bbs",
