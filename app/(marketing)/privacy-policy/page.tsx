  ...
  return (
    <>
      ...
      <section className="py-[clamp(2.5rem,calc(1.786rem+3.571vw),5rem)] bg-secondary">
        <div className="container mx-auto px-[clamp(1.25rem,calc(0.893rem+1.786vw),2.5rem)] max-w-7xl">
          <p className="text-[clamp(0.813rem,calc(0.426rem+1.932vw),1.875rem)] font-semibold text-heading mb-12 leading-relaxed">
