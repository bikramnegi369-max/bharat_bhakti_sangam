      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col justify-center text-left">
            {/* Lead Statement */}
            <ScrollReveal animation="fade-left" duration={750} delay={100}>
              <p
            ...
            <div className="space-y-4 sm:space-y-5 text-sm sm:text-base text-[#4B5563] leading-relaxed">
              {data.messageParagraphs.map((para, idx) => (
                <ScrollReveal
                  ...
                  delay={160 + idx * 80}
                >
                  <p className={`${poppins.className} font-normal`}>
                    {para}
                  </p>
                </ScrollReveal>
              ))}
            ...
            <ScrollReveal animation="fade-left" duration={750} delay={360}>
