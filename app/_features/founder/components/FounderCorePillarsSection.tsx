    ...
    <section className="relative w-full py-16 sm:py-20 lg:py-24 bg-[#FCFAF5] overflow-hidden">
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 items-stretch">
          ...
          <div className="bg-white rounded-3xl p-6 sm:p-8 border border-[#F0E6D8] shadow-[0_10px_35px_rgba(116,14,10,0.06)] hover:shadow-[0_15px_45px_rgba(116,14,10,0.1)] transition-all duration-300 flex flex-col justify-between">
            <div>
              <h3
          ...
          {/* Card 2: VISION 2030 */}
          <div className="bg-white rounded-3xl p-6 sm:p-8 border border-[#F0E6D8] shadow-[0_10px_35px_rgba(116,14,10,0.06)] hover:shadow-[0_15px_45px_rgba(116,14,10,0.1)] transition-all duration-300 flex flex-col justify-between text-center">
            <div>
              <h3
