...
import { Lightbulb, HeartHandshake, Music, MapPin, Zap, Building2 } from "lucide-react";
...
export function FounderTimelineSection() {
  ...
  const renderMilestoneIcon = (iconName: string) => {
    switch (iconName) {
      case "idea":
      case "spark":
        return <Lightbulb className="w-7 h-7 text-[#D4AF37] stroke-[1.5] transition-colors duration-300 group-hover:text-[#740E0A]" />;
      case "volunteers":
      case "hands":
        return <HeartHandshake className="w-7 h-7 text-[#D4AF37] stroke-[1.5] transition-colors duration-300 group-hover:text-[#740E0A]" />;
      case "music":
        return <Music className="w-7 h-7 text-[#D4AF37] stroke-[1.5] transition-colors duration-300 group-hover:text-[#740E0A]" />;
      case "location":
      case "globe":
        return <MapPin className="w-7 h-7 text-[#D4AF37] stroke-[1.5] transition-colors duration-300 group-hover:text-[#740E0A]" />;
      case "energy":
      case "fire":
        return <Zap className="w-7 h-7 text-[#D4AF37] stroke-[1.5] transition-colors duration-300 group-hover:text-[#740E0A]" />;
      case "movement":
      case "temple":
        return <Building2 className="w-7 h-7 text-[#D4AF37] stroke-[1.5] transition-colors duration-300 group-hover:text-[#740E0A]" />;
      default:
        return <Lightbulb className="w-7 h-7 text-[#D4AF37] stroke-[1.5] transition-colors duration-300 group-hover:text-[#740E0A]" />;
    }
  };
