      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
          ...
          <div className="lg:col-span-5 flex flex-col justify-center text-left">
            ...
            <ScrollReveal animation="scale-up" duration={650} delay={250}>
          ...
          <div className="lg:col-span-7 flex justify-center">
            ...
            >
              <div
                ...
                className="group relative w-full aspect-video rounded-2xl sm:rounded-3xl overflow-hidden border-2 border-white/20 shadow-2xl bg-black cursor-pointer focus:outline-none focus-visible:ring-4 focus-visible:ring-[#D4AF37]"
              >
                <Image
                  src={data.thumbnail}
                  alt={data.title}
