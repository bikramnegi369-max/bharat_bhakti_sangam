    ...
    <section aria-labelledby="featured-articles-heading" className="w-full">
      ...
      <div className="flex items-center justify-between gap-4 border-b border-[#740E0A]/15 pb-4 mb-6 sm:mb-8">
        <div className="relative">
          ...
          <div
            aria-hidden="true"
            className="absolute -bottom-4 sm:-bottom-[17px] left-0 w-24 sm:w-32 h-1 bg-linear-to-r from-[#740E0A] via-[#B31D12] to-[#D4AF37] rounded-full z-10"
          />
        </div>
      </div>
        ...
        {featuredPosts.map((post, idx) => {
          ...
          return (
            <article
              ...
              className="group flex flex-col overflow-hidden rounded-2xl bg-white border border-[#740E0A]/10 shadow-[0_4px_16px_rgba(0,0,0,0.03)] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_12px_28px_rgba(116,14,10,0.1)] hover:border-[#740E0A]/30"
            >
              {/* Image */}
              <Link
                href={`/${post.slug}`}
              ...
              <div className="flex flex-1 flex-col justify-between p-4 bg-white">
                ...
                <div className="mt-4 pt-3 border-t border-stone-100 flex items-center justify-between">
                  <span
                    className={`${poppins.className} text-[11px] font-medium text-stone-500 truncate max-w-[110px]`}
                  >
