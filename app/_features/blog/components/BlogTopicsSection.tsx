      ...
      <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
        {CURATED_TOPICS.map((topic, index) => {
          ...
          return (
            <div
              key={index}
              className="group flex flex-col justify-between overflow-hidden rounded-2xl bg-white border border-[#740E0A]/10 p-4 sm:p-5 shadow-[0_4px_16px_rgba(0,0,0,0.03)] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_12px_28px_rgba(116,14,10,0.1)] hover:border-[#740E0A]/30"
            >
              <div>
