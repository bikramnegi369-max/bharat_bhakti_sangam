    ...
    <section className="w-full py-12 md:py-16 bg-[#FAF7F2] border-y border-amber-100/70">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-14">
          {/* Left Leaf Shaped Frame Image — Scale-up reveal */}
          ...
          {/* Right Rituals List — Fade-left with staggered items */}
            ...
            <div className="space-y-3 sm:space-y-3.5">
              {festival.rituals.items.map((item, index) => (
                <ScrollReveal
                  ...
                  delay={100 + index * 80}
                >
                  <div className="flex items-start gap-3 p-3 sm:p-3.5 rounded-xl bg-white border border-amber-100/90 shadow-2xs hover:shadow-xs hover:border-amber-300 transition-all">
