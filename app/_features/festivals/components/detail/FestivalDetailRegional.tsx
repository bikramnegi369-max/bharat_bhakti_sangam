    ...
    <section className="w-full py-12 md:py-16 bg-[#FAF7F2] border-t border-amber-100/80">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        {festival.panoramicBanner && (
          <ScrollReveal animation="fade-up" duration={850} delay={50}>
        ...
        <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-14">
          ...
          <div className="w-full lg:w-1/2 space-y-6 text-left">
            <ScrollReveal animation="fade-left" duration={700} delay={60}>
              <div>
                <h2
            ...
            <div className="space-y-4">
              {festival.regionalCelebrations.items.map((item, index) => (
                <ScrollReveal
                  ...
                  delay={120 + index * 80}
                >
                  <div className="p-4 rounded-2xl bg-white border border-amber-100/90 shadow-2xs hover:shadow-xs hover:border-amber-300 transition-all space-y-1.5">
