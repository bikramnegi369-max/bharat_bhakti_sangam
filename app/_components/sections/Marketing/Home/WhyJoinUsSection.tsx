...
export default function WhyJoinUsSection({
  ...
  return (
    ...
    >
      ...
      >
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-212.5 h-90 bg-[radial-gradient(ellipse_at_center,rgba(212,175,55,0.08)_0%,rgba(116,14,10,0.22)_45%,transparent_75%)] blur-3xl animate-glow" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-[clamp(1.25rem,calc(0.893rem+1.786vw),2.5rem)]">
        ...
        <ScrollReveal animation="fade-down" duration={750} threshold={0.15} className="flex flex-col items-center justify-center text-center mb-12 sm:mb-16">
          ...
          {features.map((item, idx) => {
            ...
            return (
              ...
              >
                <div
                  className={clsx(
                    "group relative flex flex-col justify-start rounded-2xl p-7 sm:p-8 transition-all duration-300 ease-out h-full",
