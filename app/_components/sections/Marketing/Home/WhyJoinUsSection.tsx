  ...
  return (
    <section
      ...
      className={clsx(
        ...
        "bg-gradient-to-b from-[#2E0403] via-[#3B0504] to-[#250302] text-white",
        className
      )}
    >
      ...
      >
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[850px] h-[360px] bg-[radial-gradient(ellipse_at_center,rgba(212,175,55,0.08)_0%,rgba(116,14,10,0.22)_45%,transparent_75%)] blur-3xl" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-[clamp(1.25rem,calc(0.893rem+1.786vw),2.5rem)]">
        ...
        <div className="flex flex-col items-center justify-center text-center mb-12 sm:mb-16">
          <div className="flex items-center justify-center gap-3 sm:gap-6 w-full max-w-xl">
            <span className="h-px grow bg-gradient-to-r from-transparent via-[#D4AF37]/50 to-[#D4AF37]/80" />
            <span
              className={clsx(
                cinzel.className,
            ...
            <span className="h-px grow bg-gradient-to-l from-transparent via-[#D4AF37]/50 to-[#D4AF37]/80" />
          </div>
        </div>
          ...
          {features.map((item, idx) => {
            ...
            return (
              ...
              >
                ...
                <div
                  aria-hidden="true"
                  className="absolute inset-x-6 top-0 h-px bg-gradient-to-r from-transparent via-[#D4AF37]/40 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"
                />
