    ...
    return (
      ...
      >
        ...
        >
          ...
          {/* Hover Dark Overlay */}
          <div className="absolute inset-0 bg-linear-to-t from-black/85 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-between p-4 sm:p-5 text-white" />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-6 items-start">
        ...
        <div className="flex flex-col gap-5 lg:gap-6 md:col-span-2 lg:col-span-1">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-5 lg:gap-6">
            {col3Items[0] && renderCard(col3Items[0], "aspect-1/1", 200)}
            {col3Items[1] && renderCard(col3Items[1], "aspect-1/1", 350)}
          </div>
        </div>
      </div>
