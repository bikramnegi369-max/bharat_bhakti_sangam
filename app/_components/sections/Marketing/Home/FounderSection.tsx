...
export default function FounderSection({
  ...
  return (
    <section className="relative overflow-x-clip py-[clamp(2.5rem,calc(1.786rem+3.571vw),5rem)]">
      ...
      <div
        aria-hidden="true"
        className="pointer-events-none absolute -top-32 sm:-top-44 md:-top-56 -right-42 lg:-right-72 w-115 sm:w-140 md:w-175 lg:w-200 aspect-16/10 opacity-35 rotate-90 select-none z-0 animate-float"
      >
        <Image
          src="/welcome_bg.webp"
          alt=""
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-[clamp(1.25rem,calc(0.893rem+1.786vw),2.5rem)] grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
        ...
        >
          <div className="relative w-full max-w-105 sm:max-w-115 pb-8 sm:pb-10">
            ...
            <div className="relative p-2.5 sm:p-3.5 rounded-t-full rounded-b-none border-2 border-[#F7DCB1] bg-[#FAF6F0]/50 shadow-[0_15px_40px_rgba(116,14,10,0.08)]">
              {/* Inner Image Container with Arch Mask */}
              <div className="relative w-full aspect-4/5 rounded-t-full rounded-b-none overflow-hidden bg-[#ECE4D8] group">
                <Image
                  src={imageSrc}
                  alt={name}
                  fill
            ...
            {/* Floating Quote Card with Delayed Entrance */}
            <ScrollReveal
              animation="scale-up"
              delay={200}
              duration={750}
              threshold={0.15}
              className="absolute bottom-0 -left-2 sm:-bottom-2 sm:-left-6 w-[80%] sm:w-[72%] max-w-70 sm:max-w-77.5 z-20"
            >
              <div
                className="bg-primary text-white p-5 sm:p-6 rounded-2xl shadow-[0_20px_40px_rgba(63,6,5,0.28)] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_25px_50px_rgba(63,6,5,0.38)]"
