      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
          ...
          <div className="lg:col-span-5 flex justify-center">
            <div className="relative w-full max-w-110 aspect-4/3 rounded-2xl overflow-hidden shadow-xl border border-stone-200 bg-stone-900">
              <Image
                src={videoImg}
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 pt-2">
              {temple.timeline?.map((item, idx) => (
                <div
                  key={idx}
                  className="bg-white border border-stone-200/90 p-4 sm:p-5 rounded-xl shadow-xs hover:border-amber-400 hover:shadow-md transition-all duration-300"
                >
                  <span
