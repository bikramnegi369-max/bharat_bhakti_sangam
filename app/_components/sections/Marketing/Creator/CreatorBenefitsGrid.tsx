          ...
          {benefits.map((benefit, idx) => {
            ...
            return (
              <ScrollReveal
                ...
                className="h-full"
              >
                <div className="group relative flex flex-col items-center text-center bg-white rounded-2xl p-6 sm:p-7 md:p-8 xl:p-9 shadow-[0_4px_24px_rgba(0,0,0,0.03)] border border-neutral-100/90 transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_12px_32px_rgba(63,6,5,0.06)] hover:border-[#D4AF37]/30 h-full">
