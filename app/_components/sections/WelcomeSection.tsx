    ...
    <section className="py-[clamp(2.5rem,calc(1.786rem+3.571vw),5rem)]">
      <div className="max-w-7xl mx-auto px-[clamp(1.25rem,calc(0.893rem+1.786vw),2.5rem)] grid lg:grid-cols-2 gap-[clamp(1.25rem,calc(0.75rem+2.5vw),3rem)] items-center">
        ...
        <div>
          ...
          <h2
            className={`${cinzel.className} text-[clamp(1.25rem,calc(0.625rem+3.125vw),3.438rem)] text-primary font-bold leading-tight text-center`}
          >
            Bhajanclubbing
          </h2>
        ...
        {/* IMAGE */}
        <div className="relative w-[clamp(15.813rem,calc(10.491rem+26.607vw),34.438rem)] h-[clamp(10.313rem,calc(6.866rem+17.232vw),22.375rem)] rounded-md overflow-hidden mx-auto group aspect-video border-3 border-primary">
          <Image
