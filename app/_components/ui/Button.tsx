  ...
  ({ children, variant = "primary", onClick, className, ...props }, ref) => {
    return (
      <button
        ...
        className={clsx(
          // Base styles
          "relative overflow-hidden px-4 py-1.5 rounded-md font-medium transition-all duration-200 min-w-[clamp(6.875rem,calc(4.196rem+13.393vw),16.25rem)] text-[clamp(0.75rem,calc(0.518rem+1.161vw),1.563rem)] cursor-pointer flex items-center justify-center active:scale-95",
